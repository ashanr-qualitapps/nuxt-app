...
const _routes = [
  {
    name: "countries",
    path: "/countries",
    component: () => import("./_nuxt/countries-BkSY1lkD.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DyF2QCKN.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-COYdF--E.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Ovc2zmBE.js").then((r) => r.default || r));
